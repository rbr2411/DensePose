...
class DensePoseMethods:
    def __init__(self):
        #
        ALP_UV = loadmat( os.path.join(os.path.dirname(__file__), '/content/drive/MyDrive/DensePose-master/DensePoseData/densepose_uv_data/UV_Processed.mat')  )
        ...
        UV_symmetry_filename = os.path.join(os.path.dirname(__file__), '/content/drive/MyDrive/DensePose-master/DensePoseData/densepose_uv_data/UV_symmetry_transforms.mat')
